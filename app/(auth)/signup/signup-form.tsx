...
export function SignUpForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const parsedData = SignUpSchema.safeParse(userSignUpData);
    if (!parsedData.success) {
      toast.error('Schema/Data Format Error');
      return;
    }
    ...
    } else toast('Error', { description: response.error });
  };
  ...
  return (
    ...
    >
      <div className='flex flex-col items-center gap-2 text-center'>
        <h1 className='text-2xl font-bold'>Sign Up to TinyVault</h1>
      ...
      <div className='grid gap-6'>
        ...
        <Button disabled={isPending} type='submit' className='w-full'>
          {isPending ? (
            <>
              <span className='mx-1 animate-spin'>
                <Loader2 />
              </span>
              Processing
            </>
